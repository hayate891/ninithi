...
public class Designer extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButtonNew.setPreferredSize(new java.awt.Dimension(32, 32));
        ...
        jButtonOpen.setPreferredSize(new java.awt.Dimension(32, 32));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() >= 1) {
            ...
            if (jTable1.getSelectedColumn() == 5) {
                ...
                BGrenderer.removeListColor(jTable1.getSelectedRow());
                imageRenderer.removeImage(jTable1.getSelectedRow());
    ...
    private void jButtonNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNewActionPerformed
        ...
        JOptionPane op = new JOptionPane(
                "Are sure do you want to delete this Table",
                JOptionPane.PLAIN_MESSAGE,
                JOptionPane.OK_CANCEL_OPTION,
                null,
                null);

        JDialog dialog = op.createDialog("New...");
        dialog.setVisible(true);
        ...
        if (result==JOptionPane.OK_OPTION) {
            ...
            for (int j = x; j > 0; j--) {
                BGrenderer.removeListColor(j - 1);
                imageRenderer.removeImage(j - 1);
    ...
    private void addComponentsToToolbar() {
        ...
        url = this.getClass().getResource("Images/new.png");
        icon = new ImageIcon(url);
        jButtonNew.setIcon(icon);

        url = this.getClass().getResource("Images/save.png");
        icon = new ImageIcon(url);
        jButtonSave.setIcon(icon);

        url = this.getClass().getResource("Images/open.png");
        icon = new ImageIcon(url);
        jButtonOpen.setIcon(icon);
